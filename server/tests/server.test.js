...
describe('GET /todos/:id', () => {
  ...
  it('should not get a todo by other user', (done) => {
    request(app)
...
describe('DELETE /todos/:id', () => {
  ...
  it('should not delete a todo by other user', (done) => {
...
describe('GET /users/me', () => {
  ...
  it('should return 401 while not authenticated', (done) => {
    request(app)
      .get('/users/me')
      .set('x-auth', '')
      .expect(401)
...
describe('POST /users', () => {
  it('should create a user', (done) => {
    var email = 'andrewwijaya@gmail.com';
    var password = 'abc123';
